  ...
  return (
    <div className="navbar">
      ...
      <ul className="navbar-menu">
        ...
        >
          {" "}
          <img className="menuu" src={assets.hum_icon} alt="" /> Menu
        </a>
        <a
          href="#app-download"
        ...
        >
          {" "}
          <img className="down" src={assets.download_icon} alt="" /> Download
        </a>
        <a
          href="#footer"
        ...
        >
          {" "}
          <img className="conn" src={assets.connect_icon} alt="" /> Connect
        </a>
      </ul>
